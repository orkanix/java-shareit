...
public class ItemMapper {
    ...
    public static Item mapToItem(NewItemDto newItemDto, User user, ItemRequest itemRequest) {
        Item item = new Item();
    ...
    public static ItemBookingsDto mapToItemBookingsDto(Item item, Booking lastBooking, Booking nextBooking, List<Comment> comments) {
        return ItemBookingsDto.builder()
                ...
                .comments(comments.stream().map(CommentMapper::mapToCommentDto).collect(Collectors.toList()))
                .build();
    }

    public static AnswerDto mapToAnswerDto(Item item) {
